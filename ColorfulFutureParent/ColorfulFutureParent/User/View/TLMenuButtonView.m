...
- (void)showItems{
    ...
    CGPoint point3 = CGPointMake(center.x+r, center.y);
    CGPoint point4 = CGPointMake(center.x + r*cos(M_PI/4), center.y + r*sin(M_PI/4));
    CGPoint point5 = CGPointMake(center.x, center.y + r);
    
   // CGPoint point1 = CGPointMake(center.x - r*cos(M_PI/12), center.y+r*sin(M_PI/12));
    
    TLMenuButton *menu1 = [TLMenuButton buttonWithTitle:@"" imageTitle:@"" center:center color:ColorWithRGB(93,198,78)];
    menu1.tag = 1;
   ...
   // CGPoint point2 = CGPointMake(center.x - r*cos(M_PI / 8-M_PI*3/48), center.y - r*sin(M_PI / 8-M_PI*3/48));
    TLMenuButton *menu2 = [TLMenuButton buttonWithTitle:@"" imageTitle:@"" center:center color:ColorWithRGB(242,104,90)];
     menu2.tag = 2;
   ...
   // CGPoint point3 = CGPointMake(center.x - r*cos(M_PI / 4-M_PI/24), center.y - r*sin(M_PI / 4-M_PI/24));
    TLMenuButton *menu3 = [TLMenuButton buttonWithTitle:@"" imageTitle:@"" center:center color:ColorWithRGB(93,198,78)];
    menu3.tag = 3;
    ...
    TLMenuButton *menu4 = [TLMenuButton buttonWithTitle:@"" imageTitle:@"" center:center color:ColorWithRGB(189,111,221)];
    menu4.tag = 4;
    [menu4 addTarget:self action:@selector(_addExamApprovel:) forControlEvents:UIControlEventTouchUpInside];
    
   // CGPoint point5 = CGPointMake(center.x, center.y - r);
    TLMenuButton *menu5 = [TLMenuButton buttonWithTitle:@"" imageTitle:@"" center:center color:ColorWithRGB(87,211,200)];
    menu5.tag = 5;
    ...
    [UIView animateWithDuration:0.2 animations:^{
        ...
        self.menu4.alpha = 1;
        self.menu5.alpha = 1;
        self.menu1.center = point1;
        self.menu2.center = point2;
        self.menu3.center = point3;
        self.menu4.center = point4;
        self.menu5.center = point5;
    }];
}

- (void)dismiss{
    [UIView animateWithDuration:0.2 animations:^{
        self.menu1.center = self.centerPoint;
        self.menu2.center = self.centerPoint;
        self.menu3.center = self.centerPoint;
        self.menu4.center = self.centerPoint;
        self.menu5.center = self.centerPoint;
        self.menu1.alpha = 0;
        self.menu2.alpha = 0;
        self.menu3.alpha = 0;
        self.menu4.alpha = 0;
        ...
        [self.menu1 removeFromSuperview];
        [self.menu2 removeFromSuperview];
        [self.menu3 removeFromSuperview];
        [self.menu4 removeFromSuperview];
        [self.menu5 removeFromSuperview];
    }];
}
