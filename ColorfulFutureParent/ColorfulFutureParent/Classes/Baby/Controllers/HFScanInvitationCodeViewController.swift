//
//  HFScanInvitationCodeViewController.swift
...
public protocol HFScanInvitationCodeViewControllerDelegate: class {
     func scanFinished(scanResult: LBXScanResult, error: String?)
}

public protocol HFQRRectDelegate {
    func drawwed()
}

class HFScanInvitationCodeViewController: HFNewBaseViewController {
    
    // 返回扫码结果，也可以通过继承本控制器，改写该handleCodeResult方法即可
    open weak var scanResultDelegate: HFScanInvitationCodeViewControllerDelegate?

    open var delegate: HFQRRectDelegate?
    ...
    open override func viewDidAppear(_ animated: Bool) {
        ...
        drawScanView()
        perform(#selector(HFScanInvitationCodeViewController.startScan), with: nil, afterDelay: 0.3)
    }
...
//MARK: - 图片选择代理方法
extension HFScanInvitationCodeViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
...
//MARK: - 私有方法
private extension HFScanInvitationCodeViewController {
